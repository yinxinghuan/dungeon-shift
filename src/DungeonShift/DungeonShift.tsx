...
import { ArrowIcon, ArchiveIcon, DashIcon, HeartIcon, LockIcon, RankIcon, RelicIcon, SmokeIcon } from './icons';
...
export default function DungeonShift() {
  ...
  return (
    <main className={`ds ds--${phase}`} lang={locale}>
      ...
      <div className="ds__brand" aria-hidden="true"><img src={aigramSrc} alt="" draggable={false} /><span>FIELD TEST 02</span></div>
    </main>
  );
}
