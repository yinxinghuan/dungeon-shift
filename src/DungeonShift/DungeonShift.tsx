...
export default function DungeonShift() {
  ...
  return (
    <main className={`ds ds--${phase}`} lang={locale} data-build="range-skill-hud-v1">
      ...
      <div className="ds__brand" aria-hidden="true"><img src={aigramSrc} alt="" draggable={false} /><span>BUILD R4</span></div>
    </main>
  );
}
