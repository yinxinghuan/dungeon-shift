...
const copy = {
  ...
  en: {
    ...
    guide: 'Tap an adjacent tile. Avoid red sight, steal the relic, then return.',
    ...
    steal: 'Relic secured. Return to the entrance.', enter: 'Reach the amber vault.',
