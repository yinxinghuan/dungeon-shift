...
const copy = {
  zh: {
    ...
    steal: '宝物到手 · 跟随青色箭头返回入口', enter: '点击相邻地格 · 避开红色视线 · 前往宝库',
  ...
  en: {
    ...
    steal: 'RELIC SECURED · FOLLOW THE CYAN ARROW HOME', enter: 'TAP AN ADJACENT TILE · EVADE RED SIGHT · REACH THE VAULT',
